...
public interface Map<K,V> {
    ...
    /* This method returns true if the Map contains a mapping for the specified key, and false otherwise. */
    boolean containsKey(K key);

    /* This method returns true if the Map contains a mapping for the specified value, and false otherwise. */
